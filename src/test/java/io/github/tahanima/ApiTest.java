...
import io.github.tahanima.api.payload.*;
...
class ApiTest extends BaseTest {
    ...
    void testGetBookingByIdReturns200() {
        ...
        int id = BookingApi.createBooking(bookingRequestPayload).as(BookingResponsePayload.class).getBookingId();
    ...
    void testCreateBookingReturnsCorrectDetails() {
        ...
        assertThat(bookingRequestPayload.equals(bookingResponsePayload.getBookingRequestPayload()), is(true));
    }
